...
namespace DownUnder.UI.UI.Widgets.DataTypes {
    ...
    public abstract class OverlayWidgetLocation : ICloneable {
        ...
        public static CoverParentOverlay CoverParent(int parent_up) =>
            new CoverParentOverlay(parent_up);

        public static SideOfParent SideOfParent(int parent_up, Direction2D parent_side) =>
            new SideOfParent(parent_up, parent_side);
    }
}
