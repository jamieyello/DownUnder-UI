...
namespace DownUnder.Utilities {
    public static class OSInterface {
        public static void CopyTextToClipBoard(string text) => System.Windows.Forms.Clipboard.SetText(text);
        public static void CopyObjectToClipboard(object obj, bool copy) => System.Windows.Forms.Clipboard.SetDataObject(obj, copy);
        public static string GetTextFromClipboard() => System.Windows.Forms.Clipboard.GetText();
        ...
        public static float CaretBlinkTime => System.Windows.Forms.SystemInformation.CaretBlinkTime / 500f;
