...
{
    /// <summary>
    /// The color settings of any UI element.
    /// </summary>
    [DataContract]
    public class UIPalette
    {
        ...
        /// <summary>
        /// Color to shift to when nothing of interest is happening.
        /// </summary>
        [DataMember] public Color DefaultColor { get; set; } = Color.Black;
        /// <summary>
        /// Color to shift to when this element is hovered over.
        /// </summary>
        [DataMember] public Color HoveredColor { get; set; } = Color.White;
        /// <summary>
        /// Color to toggle when SpecialColorEnabled is enabled. No transition.
        /// </summary>
        [DataMember] public Color SpecialColor { get; set; } = Color.Black;
        /// <summary>
        /// The type of interpolation to be used when shifting between colors.
        /// </summary>
        ...
        /// <summary>
        /// How fast colors should shift. (1 = immediate)
        /// </summary>
        [DataMember] public float TransitionSpeed { get => _changing_color.TransitionSpeed; set => _changing_color.TransitionSpeed = value; }
        /// <summary>
        /// Whether this element currently shifts towards the hovered color or the default color.
        /// </summary>
        public bool Hovered { get; set;}
        /// <summary>
        /// The color that this element should display at this moment.
        /// </summary>
        public Color CurrentColor { get => _changing_color.GetCurrent(); }
        /// <summary>
        /// Returns true if this is in the middle of transitioning to a different color.
        /// </summary>
        public bool IsTransitioning { get => _changing_color.IsTransitioning; }
        /// <summary>
        /// When set to true this will display the special color.
        /// </summary>
